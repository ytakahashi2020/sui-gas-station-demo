...
exports.EXAMPLE_BENEFICIARY_GRAPH_ID_TESTNET = exports.BULLSHARK_QUEST_BENEFICIARY_GRAPH_ID_MAINNET = exports.ShinamiWalletSigner = exports.KeySession = exports.WalletClient = exports.SignTransactionResult = exports.KeyClient = void 0;
...
class KeyClient extends rpc_js_1.ShinamiRpcClient {
    ...
    createSession(secret) {
        return this.request("shinami_key_createSession", [secret], (0, superstruct_1.string)());
    }
}
 ...
 */
exports.SignTransactionResult = (0, superstruct_1.object)({
...
class WalletClient extends rpc_js_1.ShinamiRpcClient {
    ...
    createWallet(walletId, sessionToken) {
        return this.request("shinami_wal_createWallet", [walletId, sessionToken], (0, superstruct_1.string)());
    }
    /**
     ...
     */
    getWallet(walletId) {
        return this.request("shinami_wal_getWallet", [walletId], (0, superstruct_1.string)());
    }
    /**
    ...
    signTransaction(walletId, sessionToken, txBytes) {
        if (txBytes instanceof Uint8Array)
            txBytes = (0, utils_1.toB64)(txBytes);
        return this.request("shinami_wal_signTransactionBlock", [walletId, sessionToken, txBytes], exports.SignTransactionResult);
    }
    /**
    ...
    signPersonalMessage(walletId, sessionToken, message, wrapBcs = true) {
        if (message instanceof Uint8Array)
            message = (0, utils_1.toB64)(message);
        return this.request("shinami_wal_signPersonalMessage", [walletId, sessionToken, message, wrapBcs], (0, superstruct_1.string)());
    }
    /**
    ...
    executeGaslessTransaction(walletId, sessionToken, tx, options, requestType) {
        return this.request("shinami_wal_executeGaslessTransactionBlock", (0, rpc_js_1.trimTrailingParams)([
            walletId,
            sessionToken,
            tx.txKind,
            tx.gasBudget,
    ...
    setBeneficiary(walletId, sessionToken, beneficiaryGraphId, beneficiaryAddress) {
        return this.request("shinami_walx_setBeneficiary", [walletId, sessionToken, beneficiaryGraphId, beneficiaryAddress], (0, superstruct_1.string)());
    }
    /**
     * [Beneficiary Graph API]
    ...
    unsetBeneficiary(walletId, sessionToken, beneficiaryGraphId) {
        return this.request("shinami_walx_unsetBeneficiary", [walletId, sessionToken, beneficiaryGraphId], (0, superstruct_1.string)());
    }
    /**
     * [Beneficiary Graph API]
    ...
    getBeneficiary(walletId, beneficiaryGraphId) {
        return this.request("shinami_walx_getBeneficiary", [walletId, beneficiaryGraphId], (0, superstruct_1.nullable)((0, superstruct_1.string)()));
    }
}
    ...
    _getAddress(autoCreate) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (autoCreate && e instanceof client_js_1.JSONRPCError && e.code === -32602) {
 ...
 */
exports.BULLSHARK_QUEST_BENEFICIARY_GRAPH_ID_MAINNET = "0x39fabecb3e74036e6140a938fd1cb194a1affd086004e93c4a76af59d64a2c76";
/**
 * Example beneficiary graph id published on Testnet.
 * Must be used with a Testnet access key.
 */
exports.EXAMPLE_BENEFICIARY_GRAPH_ID_TESTNET = "0x1987692739e70cea40e5f2596eee2ebe00bde830f72bb76a7187a0d6d4cea278";
