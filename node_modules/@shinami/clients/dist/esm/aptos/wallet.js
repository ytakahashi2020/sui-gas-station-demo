...
import { AccountAddress, Deserializer, AccountAuthenticator, } from "@aptos-labs/ts-sdk";
import { array, integer, object, string, unknown } from "superstruct";
...
export class WalletClient extends ShinamiRpcClient {
    ...
    signTransaction(walletId, sessionToken, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            const { signature } = yield this.request("wal_signTransaction", trimTrailingParams([
                walletId,
                sessionToken,
            ...
            return AccountAuthenticator.deserialize(new Deserializer(new Uint8Array(signature)));
        });
    }
