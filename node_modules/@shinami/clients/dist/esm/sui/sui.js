 ...
 */
export function createSuiClient(accessKey, url = inferRegionalValueFromAccessKey(accessKey, NodeRpcUrls, (nodeRpcUrls) => nodeRpcUrls.us1), wsUrl = inferRegionalValueFromAccessKey(accessKey, NodeWsUrls, (nodeWsUrls) => nodeWsUrls.us1)) {
