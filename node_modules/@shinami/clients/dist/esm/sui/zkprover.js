 ...
 */
import { object, type } from "superstruct";
...
export class ZkProverClient extends ShinamiRpcClient {
     ...
     */
    constructor(accessKey, url = inferRegionalValueFromAccessKey(accessKey, ZkProverRpcUrls, (zkProverRpcUrls) => zkProverRpcUrls.us1)) {
        super(accessKey, url);
    }
    /**
    ...
    createZkLoginProof(jwt, maxEpoch, ephemeralPublicKey, jwtRandomness, salt, keyClaimName) {
        return this.request("shinami_zkp_createZkLoginProof", trimTrailingParams([
            jwt,
            maxEpoch.toString(),
